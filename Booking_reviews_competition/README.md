...
**Business task:** to help company to determine dishonest hotels and make platform more effective<br>
**Technical challenge:** to build a machine learning model that will predict hotel score by proposed features
